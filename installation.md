...
8. Кстати, текст в кавычках может быть любым) Запустим нашу программу. Нажимаем на кнопку Run в правом верхнем углу или используем комбинацию клавиш Ctrl+Shift+F10. Если у вас не запускается первым способом, попробуйте комбинацию клавиш.  
