...
green_square = pygame.transform.scale(pygame.image.load('sq.png').convert_alpha(), (TILE_SIZE, TILE_SIZE))
red_square = pygame.transform.scale(pygame.image.load('sr.png').convert_alpha(), (TILE_SIZE, TILE_SIZE))
