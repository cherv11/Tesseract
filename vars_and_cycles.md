...
Привет! Мы начинаем цикл лекций об основах Python. Даже если вы знакомы с основами языка, это отличный шанс всё повторить и узнать какие-то нюансы. А если вам всё равно станет скучно, у нас есть задачи (помечены символом ❓), за которые можно получить баллы на паре. Сегодня вы узнаете:
