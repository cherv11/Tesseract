...
Дано время в секундах: s = 560. Переведите это в минуты и секунды, записав значение в две переменные.
```

## Типы данных
Пока мы изучаем 4 типа данных: булев тип, целые числа, дробные числа, строки
- bool — принимает только значения True/False (1 и 0), что позволяет ему занимать один бит в памяти
...
```
Перевод одних типов данных в другие
```py
