...
7. Дана строка, например: `a = 'Какао фабрика'`. Напишите программу, которая посчитает количество букв `a` в строке, и если оно равно трём, выведет `'три a'`, иначе выведет строку, в которой будет столько же букв `a`, сколько в исходной строке.
